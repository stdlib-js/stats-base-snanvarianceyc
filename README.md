...
```javascript
snanvarianceyc = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-snanvarianceyc@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-snanvarianceyc@umd/bundle.js"></script>
```
